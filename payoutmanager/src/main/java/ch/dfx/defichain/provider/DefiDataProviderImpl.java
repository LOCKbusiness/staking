...
public class DefiDataProviderImpl implements DefiDataProvider {
  ...
  public String getRawTransaction(
      ...
      String blockHash) throws DfxException {
    LOGGER.trace("getRawTransaction(): transactionId=" + transactionId + " / blockHash=" + blockHash + " ...");

    List<Object> paramList = Arrays.asList(transactionId);// , false, blockHash);

    return getData("getrawtransaction", paramList, DefiRawTransactionResultData.class).getResult();
  }
  ...
  public DefiTransactionData getTransaction(@Nonnull String transactionId) throws DfxException {
    String rawTransaction = getRawTransaction(transactionId, null);
